...
public class AppMain {
    ...
    public static void printFilteredAccounts(List<Account> accounts) {
        ...
        List<Account> accountsWithTooMuchMoney = filter(accounts, account -> account.getBalance() >= 100_000_000L && !account.isLocked());

        nonEmptyAccounts.forEach(account -> System.out.print(account.getNumber() + " "));
        accountsWithTooMuchMoney.forEach(account -> System.out.print(account.getNumber() + " "));
    }
