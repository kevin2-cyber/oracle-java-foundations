...
public class ChainOfResponsibilityDemo {
     ...
     */
    static RequestHandler wrapInTransactionTag = req -> new Request(
            String.format("<transaction>%s</transaction>", req.getData())
    );
    ...
    interface RequestHandler {
        ...
        default RequestHandler setSuccessor(RequestHandler successor) {
            return req -> successor.handle(this.handle(req));
        }
    }
